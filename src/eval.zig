...
const mg_value: [7]i32 = .{ 0, 82, 337, 365, 477, 1025,  0};
const eg_value: [7]i32 = .{ 0, 94, 281, 297, 512,  936,  0};
...
pub fn eval(game: *const Game) i14 {
    ...
    for (0..16) |id| {
        ...
        score += mg_value[@intFromEnum(game.board.pieces[id])] * mg_phase + eg_value[@intFromEnum(game.board.pieces[id])] * eg_phase;
    }
    for (16..32) |id| {
